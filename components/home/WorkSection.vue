...
const projects = [
  ...
  },
  {
    ...
    blobColor: 'var(--warm)',
    codeHtml: `<div><span class="s-cm">// Refonte Studio Design Graphique</span></div><div><span class="s-fn">await transporter.sendMail(mailOptions);</span></div>`,
  },
  {
    ...
    blobColor: '#7B61FF',
    codeHtml: `<div><span class="s-cm">// Brand identity + WebGL</span></div><div><span class="s-fn">setup</span>() { <span class="s-kw">return</span> <span class="s-fn">useWebGL</span>(<span class="s-vr">canvasRef</span>) }</div>`,
  },
  {
